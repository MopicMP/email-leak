...
[![PyPI version](https://badge.fury.io/py/email-leak.svg)](https://pypi.org/project/email-leak/)
...
```bash
pip install email-leak
```

## Quick Start

```python
from email_leak import leak
